...
module.exports = {
	'theme': "cyborg"
	,'stylesheet': ""
	,'title': "Gameunits (UNITS) Giveaway - Get free Giveaway every 1 hour!"
	,'brand': "Gameunits Giveaway"
	,'copyright': '<a href="http://gameunits.org">UNITS Foundation</a>'
	,'coin': "Gameunits"
	,'symbol': "UNITS"
	,'pages':{
		'home':{
			'h1':"Gameunits (UNITS) Giveaway"
			,'faucet_text':'This Giveaway site automatically pays out Gameunits on a schedule. Enter your Gameunits address below to receive free UNITS. <a href="https://gameunits.org">Need a Gameunits wallet?</a>'
			,'payout_header':'Payout Chances'
			,'payout_header2':'Gameunits Left'
		}
	}
